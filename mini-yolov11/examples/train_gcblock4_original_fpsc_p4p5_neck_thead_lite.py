...
def main():
    ...
    model = YOLO(ROOT / "ultralytics/cfg/models/v11/yolov11_gcblock4_original_fpsc_p4p5_neck_thead_lite.yaml")
    results = model.train(
        data=data_cfg,
        epochs=100,
        imgsz=640,
        ...
        device=0,
        project=ROOT / "runs",
        name="WasteSortingv3_yolov11_gcblock4_original_fpsc_p4p5_neck_thead_lite",
        exist_ok=True,
        pretrained=False,
        val=True,
        plots=True,
