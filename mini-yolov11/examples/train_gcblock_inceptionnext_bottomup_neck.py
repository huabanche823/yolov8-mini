...
def main():
    ...
    model = YOLO(ROOT / "ultralytics/cfg/models/v11/yolov11_gcblock_inceptionnext_bottomup_neck.yaml")
    results = model.train(
        ...
        device=0,
        project=ROOT / "runs",
        name="WasteSortingv3_yolov11_gcblock_inceptionnext_bottomup_neck",
        exist_ok=True,
        pretrained=False,
        val=True,
        plots=True,
