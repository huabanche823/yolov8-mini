...
def main():
    ...
    model = YOLO(ROOT / "ultralytics/cfg/models/v11/yolov11_grn4_ghostv2_dfc_p4p5_thead_lite_direct.yaml")
    ...
    results = model.train(
        ...
        device=0,
        project=ROOT / "runs",
        name="WasteSortingv3_yolov11_grn4_ghostv2_dfc_p4p5_thead_lite_direct",
        exist_ok=True,
        pretrained=False,
        val=True,
        plots=True,
