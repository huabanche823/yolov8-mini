...
def main():
    ...
    model = YOLO(ROOT / "ultralytics/cfg/models/v11/yolov11_grn4_sapa_p3_p4_thead_lite_direct.yaml")
    ...
    results = model.train(
        ...
        device=0,
        project=ROOT / "runs",
        name="WasteSortingv3_yolov11_grn4_sapa_p3_p4_thead_lite_direct",
        exist_ok=True,
        pretrained=False,
        val=True,
        plots=True,
