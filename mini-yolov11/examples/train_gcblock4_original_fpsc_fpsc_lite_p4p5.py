...
def main():
    ...
    model = YOLO(ROOT / "ultralytics/cfg/models/v11/yolov11_gcblock4_original_fpsc_fpsc_lite_p4p5.yaml")
    results = model.train(
        ...
        device=0,
        project=ROOT / "runs",
        name="WasteSortingv3_yolov11_gcblock4_original_fpsc_fpsc_lite_p4p5",
        exist_ok=True,
        pretrained=False,
        val=True,
        plots=True,
