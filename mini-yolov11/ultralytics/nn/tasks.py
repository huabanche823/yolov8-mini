    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            if m in repeat_modules:
                ...
                n = 1
            if m in frozenset({C3k2, C3k2_CAAResidual, C3k2_CrossConvLite, C3k2_DCBLite, C3k2_DDFM, C3k2_DSConv, C3k2_EAConvLite, C3k2_FADC, C3k2_FDConv, C3k2_EMA, C3k2_ODConv, C3k2_FocalModulationLite, C3k2_GCResidual, C3k2_HorNetResidual, C3k2_InceptionNeXtLite, C3k2_MCA, C3k2_MobileOneLite, C3k2_MogaResidual, C3k2_GhostV2DFC, C3k2_MSBlock, C3k2_MSBlockLite, C3k2_RFAConv, C3k2_RepMixerLite, C3k2_SCConv, C3k2_SEResidual, C3k2_SFSConv, C3k2_SCSALite, C3k2_SHSA, C3k2_StarBlockLite, PConvFasterC3k2}):  # for M/L/X sizes
                legacy = False
                if scale in "mlx":
                    args[3] = True
            if m is A2C2f:
